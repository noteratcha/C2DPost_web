  ...
  return (
    <div className="gate-screen">
      <div className="gate-card">
        {onToggleTheme && (
          <div className="gate-theme-segmented-wrapper">
        ...
        <div className="gate-actions-container">
          ...
          <div className="action-card zip-install">
            <div className="action-card-header">
              ...
              <div>
                <strong>
                  <span className="opt-label opt-2">ทางเลือกที่ 2:</span> ติดตั้งผ่านไฟล์ .ZIP v1.4.0 (พร้อมระบบกรอกข้อมูลและค้นหา e-AR อัตโนมัติ)
                </strong>
            ...
            >
              ...
              ดาวน์โหลดไฟล์ C2DPost Helper v1.4.0 (.zip)
            </a>
          </div>
        </div>
