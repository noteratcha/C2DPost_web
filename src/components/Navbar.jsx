        ...
        <div className="navbar-container">
          ...
          <div className="navbar-left-group">
            ...
            <div className="brand-identity-stack">
              ...
              <h1 className="header-office-title" title={user ? orgName : 'ระบบแปลงข้อมูลจากไฟล์ PDF เพื่อเตรียมข้อมูลสำหรับระบบ DPost ด้วย API'}>
                {user && (
                ...
                <span>{user ? orgName : 'ระบบแปลงข้อมูลจากไฟล์ PDF เพื่อเตรียมข้อมูลสำหรับระบบ DPost ด้วย API'}</span>
              </h1>
            </div>
          </div>
