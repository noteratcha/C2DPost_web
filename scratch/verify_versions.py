...
assert v_config == 'v2026.0925.0635', 'Config version mismatch'
assert v_pkg == '2026.0925.0635', 'Package version mismatch'
assert v_py == '2026.0925.0635', 'Python version mismatch'
assert v_doc, 'Doc version mismatch'
assert v_road, 'Roadmap version mismatch'
assert v_bug, 'Bugfix version mismatch'
print('ALL 6 VERSIONS PERFECTLY SYNCHRONIZED TO v2026.0925.0635!')
