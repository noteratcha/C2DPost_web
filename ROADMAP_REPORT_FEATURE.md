...
- [x] **4.3 บันทึกประวัติและเลขเวอร์ชัน**
  - อัปเดตเลขเวอร์ชันของเว็บ (`APP_VERSION`) เป็น `v2026.0914.2040` ตามกฎ `vYYYY.MMDD.HHMM` (Section 15)
...
- [x] **4.9 ปรับปรุง UI/UX สู่ Page-Based Navigation (`v2026.0914.2040`)** — ปรับโครงสร้างระบบหน้าเว็บให้กดแต่ละเมนูแล้วเปิดเป็นหน้านั้นๆ แบบ Full Page (แปลงไฟล์ PDF, รายงานรับฝาก, ตรวจสอบพัสดุ, จัดการระบบ Admin) พร้อมรักษาสถานะข้อมูลตารางเดิมไว้ 100% ไม่สูญหายเมื่อสลับหน้า
